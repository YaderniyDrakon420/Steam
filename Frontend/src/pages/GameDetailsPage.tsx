import { useEffect, useState, useContext } from "react"; // Виправлено: додав useContext в імпорт
...
export default function GameDetailsPage() {
    ...
    // 1. Підключаємо твій AuthContext
    ...
    useEffect(() => {
        const fetchGameAndStatus = async () => {
            try {
                ...
                // 1. Отримуємо дані гри (доступно всім, навіть неавторизованим)
                ...
                // 2. Перевіряємо бібліотеку ТІЛЬКИ якщо користувач авторизований
                if (isAuthenticated && userId) {
                    ...
                    // Якщо не авторизований — гра точно не може бути в бібліотеці
        ...
        fetchGameAndStatus();
    }, [id, isAuthenticated, userId]); // Реагуємо на зміну акаунта
        ...
        <div className="game-bg">
            ...
            <div className="container">
                ...
                <div className="left-column">
                    ...
                    {/* SCREENSHOTS (MOCK/PLACEHOLDER GALLERY) */}
                    <div className="thumbs">
                        {[displayImage, displayImage, displayImage, displayImage].map((img, i) => (
                            <img key={i} src={img} className="thumb-item" alt="" />
                        ))}
                    </div>
                    ...
                    <div style={{ marginBottom: "30px" }}>
                        ...
                        <img src={displayImage} style={{ width: "100%", borderRadius: 6, marginTop: 20 }} alt="" />
                    </div>
                            ...
                            return (
                                <div key={r} className="review-card">
                                    <div className="review-top">
                                        <div className="review-icon" style={{ background: positive ? "#6ea84a" : "#a84a4a", display: "flex", alignItems: "center", justifyContent: "center", fontSize: 24 }}>
                                            {positive ? "👍" : "👎"}
                                        </div>
                                        <div className="review-meta">
                                            <div className="review-user-row">
                                                <span>@user_generic</span>
                                                <span>Posted on: November 23</span>
                                            </div>
                                            <div className="review-recommend" style={{ color: positive ? "#9bcf6b" : "#e06b6b" }}>
                                                {positive ? "This user recommends this game" : "This user doesn't recommend this game"}
                                            </div>
                                        </div>
                                    </div>
                                    <div className="review-bottom">
                                        <div className="review-text">
                                            Amazing gameplay and atmosphere. One of the best multiplayer experiences. Great visuals and satisfying gameplay loop.
                                        </div>
